...
import inspect
from huggingface_model_utils import download_all_models, load_model_from_local_path
...
os.environ['HF_TOKEN'] = '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'

# Download all models
download_all_models()

# Load model want to use
